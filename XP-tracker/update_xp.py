...
# Path to README.md at the root of the repo
README_PATH = Path(__file__).resolve().parent.parent / "README.md"

def calculate_cumulative_xp(weeks, xp_per_week=3500):
    """Return cumulative XP totals for each week."""
    return [week * xp_per_week for week in range(1, weeks + 1)]

def update_readme(weeks=8, xp_per_week=3500):  # default now set to 8
    """Update README.md with the XP scoreboard."""
    # Read README
